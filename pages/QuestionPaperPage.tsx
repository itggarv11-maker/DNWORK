...
const QuestionPaperPage: React.FC = () => {
    ...
    const handleGradePaper = async () => {
        ...
        try {
            ...
            saveWorkToHistory({
                type: 'Graded Paper',
                title: `Graded: ${questionPaper?.title}`,
                data: { gradedPaper: result, originalPaper: questionPaper },
                subject: subject || undefined,
            });
            setStep('results');
    ...
    const renderGeneratedPaper = () => (
        <div className="space-y-6">
            ...
            <div ref={paperRef} className="p-8 bg-white text-black rounded-lg shadow-lg font-handwritten">
                <h2 className="text-3xl font-bold text-center">{questionPaper?.title}</h2>
                <div className="flex justify-between my-2 text-lg font-bold">
                    <span>Subject: {subject}</span>
                    <span>Total Marks: {questionPaper?.totalMarks}</span>
                </div>
                <p className="text-sm italic my-4">{questionPaper?.instructions}</p>
                    ...
                    {questionPaper?.questions.map((q, index) => (
                        <div key={index}>
                            ...
                            {q.questionType === 'mcq' && q.options && (
                                <div className="grid grid-cols-2 gap-x-8 gap-y-2 mt-2 pl-4 text-lg">
        ...
        <div className="space-y-6">
            ...
            <Card variant="light">
                <div className="text-center space-y-2">
                    ...
                    <div className="text-slate-700 font-semibold mt-4">Overall Feedback:</div>
                    <div className="text-slate-600 max-w-2xl mx-auto"><MathRenderer text={gradedPaper?.overallFeedback || ''} /></div>
                </div>
            </Card>
                        ...
                        return (
                            <div key={index} className="p-4 bg-white/60 rounded-lg border-2 border-slate-300">
                                <div className="flex justify-between items-start mb-2">
                                     <div className="font-semibold text-slate-800 flex-grow">
                                        <MathRenderer text={`${index + 1}. ${q.question}`} />
                                    </div>
                                ...
                                <div className="bg-indigo-50 p-3 rounded-md border border-indigo-100 mt-2 text-sm space-y-2">
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <div>
                                            ...
                                            <MathRenderer text={gradedQ.feedback.whatWasCorrect} className="text-slate-700" />
                                        </div>
                                    </div>
                                    <div className="flex gap-2">
                                        ...
                                        <div>
                                            <strong className="text-red-700">What went wrong:</strong>
                                             <MathRenderer text={gradedQ.feedback.whatWasIncorrect} className="text-slate-700" />
                                        </div>
                                    </div>
                                    <div className="flex gap-2">
                                        ...
                                        <div>
                                            ...
                                            <MathRenderer text={gradedQ.feedback.suggestionForImprovement} className="text-slate-700" />
                                        </div>
                                    </div>
                                </div>
                            </div>
